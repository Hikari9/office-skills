...
cycle** — `auto-office/skills/claude-cli-send-message/SKILL.md` answers both in place with verified keystrokes
...
- **State exclusions explicitly.** An unstated exclusion is one a helpful agent will "finish" for you.
  ...
  [fan-out.md](fan-out.md)) and say in the brief that it is explicitly not their work.
