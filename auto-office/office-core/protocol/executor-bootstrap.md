...
The PR remains draft through implementation, verification, and review. After the review tier's exit
state — the final reviewer's `APPROVED`, or the recorded inline pass for an inline-routed task — and
a green final gate, the **orchestrator** — not the dedicated planner,
