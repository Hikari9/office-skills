---
name: claude-cli
description: The claude CLI adapter — --cli vs --in-session, the fork gotcha, session/worktree identity. Loaded by the auto-office hub when the claude route is selected; not invoked directly.
---
