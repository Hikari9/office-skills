...
description: Adversarial review gate — fresh Opus reviewer, three verdicts, evidence rules, 5-round cap. Loaded by the auto-office hub when the claude route is selected; not invoked directly.
---
