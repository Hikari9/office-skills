...
**v2 can use a dedicated planner without changing the orchestrator, executor, or reviewer routes.**
...
planner efforts, deterministic reuse, and protection of executor/reviewer routing. v3 adaptive
