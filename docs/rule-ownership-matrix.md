...
| Claude: Phase 4, commit/gate/PR/document/sync/close-loops sequence, ≤6-line report, "make the skill better" routing | `auto-office/skills/claude-closeout/SKILL.md` + `auto-office/references/closeout.md` |
