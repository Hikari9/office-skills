...
| Tracking issue is identified before plan approval and the draft PR body carries the issue plus an immutable plan blob deeplink | core | `office-core/protocol/plan-contract.md` (Run metadata and tracking issue) | All three planning/executor routes | User-directed core 5.2.0 lifecycle change |
